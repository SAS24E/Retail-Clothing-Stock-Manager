...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $conn->prepare("INSERT INTO product (name, brand, category, size, color, price, quantity, low_stock_threshold, created_at, updated_at) 
                           VALUES (?, ?, ?, ?, ?, ?, ?, ?, NOW(), NOW())");
    $stmt->bind_param("ssssssii", $name, $brand, $category, $size, $color, $price, $quantity, $threshold);
